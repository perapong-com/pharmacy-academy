...
// Mock course data - in real app, this would come from API/props
const COURSE_DATA: CartItem = {
    id: 1,
    title: 'Advance UX/UI Design Using Figma',
    instructor: 'Patrick C. Amore',
    price: 4990,
...
const CoursesDetailsArea = () => {
  ...
  const alreadyInCart = isInCart(COURSE_DATA.id);
                            ...
                            <div className="courses-sidebar-area sticky-style">
                                <div className="courses-items">
                                    ...
                                    <div className="courses-content">
                                        <h3>฿{COURSE_DATA.price.toLocaleString()}</h3>
                                        <p>
                                        ...
                                        <div className="courses-btn">
                                            <button 
                                                ...
                                                style={{
                                                    opacity: alreadyInCart ? 0.7 : 1,
                                                    cursor: alreadyInCart ? 'not-allowed' : 'pointer',
                                                }}
                                            >
                                                {alreadyInCart ? 'อยู่ในตะกร้าแล้ว' : 'Add To Cart'}
                                            </button>
                                            <button 
