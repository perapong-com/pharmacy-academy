            ...
            <section className="event-section fix section-padding section-bg pb-0">
                <div className="container">
                    <div className="section-title text-center">
                        ...
                        <h2 className="wow fadeInUp text-resp-h2 font-bold mt-2" data-wow-delay=".3s">Webinar on Emerging Trends</h2>
                    </div>
                    <div className="row">
                                            ...
                                            <div className="accordion-btn">
                                                <div className="content-items">
                                                    ...
                                                    <div className="content">
                                                        <h5 className="text-resp-h3 font-bold mb-0"><Link href="/event-details" className="hover:text-primary transition-colors">{item.title}</Link></h5>
                                                    </div>
                                                </div>
                                                ...
                                                <ul className="button-list">
                                                    <li>
                                                        ...
                                                        <span className="text-resp-info font-medium">{item.location}</span>
                                                    </li>
                                                    <li>
                                                        <Link href="/event-details" className="theme-btn text-resp-btn">View Events</Link>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                    ...
                    <div className="event-button text-center mt-5 wow fadeInUp" data-wow-delay=".3s">
                        <Link href="/event" className="theme-btn text-resp-btn yellow-btn">View All Events</Link>
                    </div>
                </div>
