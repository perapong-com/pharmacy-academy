                    ...
                    <div className="col-lg-5 col-md-7">
                        <div style={{
                            ...
                            <div style={{
                                ...
                                <h5 style={{ margin: '0 0 5px', fontWeight: '600', fontSize: '18px', color: '#fff' }}>Scan to pay.</h5>
                                <p style={{ margin: 0, opacity: 0.8, fontSize: '13px' }}>Please scan within the specified time.</p>
                            </div>
                            ...
                            <div style={{ padding: '25px', textAlign: 'center' }}>
                                ...
                                <div style={{
                                    ...
                                    <div style={{
                                        width: '160px',
                                        height: '160px',
                                        background: `url('https://api.qrserver.com/v1/create-qr-code/?size=160x160&data=promptpay-${orderId}')`,
                                ...
                                <div style={{
                                    ...
                                    <div style={{ textAlign: 'center', flex: 1 }}>
                                        ...
                                        <p style={{ margin: 0, fontSize: '14px', color: '#666' }}>1. Open your banking app.</p>
                                    </div>
                                    <div style={{ textAlign: 'center', flex: 1 }}>
                                        <div style={{
                                            width: '36px',
                                        ...
                                        <p style={{ margin: 0, fontSize: '14px', color: '#666' }}>2. Scan the QR code.</p>
                                    </div>
                                    <div style={{ textAlign: 'center', flex: 1 }}>
                                        <div style={{
                                            width: '36px',
                                        ...
                                        <p style={{ margin: 0, fontSize: '14px', color: '#666' }}>3. Automatic confirmation system.</p>
                                    </div>
                                </div>
